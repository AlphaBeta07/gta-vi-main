      ...
      {showContent && (
        <div className="main w-full rotate-[-10deg] scale-[1.7]">
          ...
          <div className="relative w-full bg-black">
            ...
            <div className="cntnr relative z-20 flex flex-col lg:flex-row text-white w-full max-w-[1200px] mx-auto h-auto px-10 py-20 gap-10">
              <div className="limg relative w-full lg:w-1/2 h-[400px] lg:h-auto flex items-center justify-center">
                <img
                  className="scale-[1.1] max-w-full max-h-full object-contain"
                  src="./imag.png"
                  alt="Boy Holding Bull"
                />
              </div>

              <div className="rg w-full lg:w-1/2 space-y-6">
                ...
                <p className="text-lg md:text-xl font-[Helvetica_Now_Display]">
                ...
                <button className="bg-yellow-500 px-8 py-4 text-black text-2xl font-semibold hover:bg-yellow-400 transition-all rounded-md">
                  Download Now
                </button>
              </div>
            </div>
